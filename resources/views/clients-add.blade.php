...
<div class="container" style="background-color: white">
    ...
    <form action="{{route('client-create')}}" method="POST">
              ...
              <div class="col">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                      <select id ="byear" name="byear" class="form-control" required>
                    ...
                    <div class="form-group col-md-3">
                       <select id="bmonth" class="form-control" name="bmonth" onkeyup="check()" required>
                    ...
                    <div class="form-group col-md-4">
                      <select placeholder="Date" name="bday" id="bday" class="form-control" required>
        ...
        <div class="row">
            ...
            <div class="col">
              ...
              <div class="containers">
                <div class="toggle">
                    <div  class="toggle-button" onclick="status()"></div>
                </div>
                <input name="status" value="Inactive" class="text" style="display: none">Inactive
              </div>
            </div>
        </div></br>
        <div class="row">
        ...
        <input type="submit" class="addbtn" value="SAVE" style="margin-bottom: 20px"></br>
      </form>
</div>
