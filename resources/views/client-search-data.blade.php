...
<div class="container">
    <a href="{{route('client-new')}}"><button class="addclient-btn">+Create New</button></a>
        ...
        <td>
            <div><input type="text" name="search" class="search-btn" placeholder="search...">
            ...
            <tr>
                ...
                <?php
                 if(($res->status)=="Active"){
                    echo '<td><button class="active-btn">'.$res->status.'</button></td>';}
                 else{
                    echo '<td><button class="inactive-btn">'.$res->status.'</button></td>';}
                ?>
                <td>
